"""
Глобальные пути для проекта Label Craft 2025.

Заполняются один раз при развёртывании.
Все агенты используют только эти константы + относительные пути внутри них.
"""
